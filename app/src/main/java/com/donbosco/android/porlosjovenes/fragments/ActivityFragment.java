...
public class ActivityFragment extends Fragment implements LoaderManager.LoaderCallbacks<RunConfig>
{
    ...
    private Button btnActivityBegin;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        btnActivityBegin = rootView.findViewById(R.id.btn_activity_begin);
        btnActivityBegin.setEnabled(false);
    ...
    public void onLoadFinished(Loader<RunConfig> loader, RunConfig data)
    {
        if(data != null)
        {
            btnActivityBegin.setEnabled(true);
            runConfig = data;
        }
    }
