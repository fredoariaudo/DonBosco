...
public class HistoryRvAdapter extends ArrayRvAdapter<Event, HistoryRvAdapter.HitoryViewHolder>
{
    private RvAdapterListener rvAdapterListener;

    protected static class HitoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        private RvAdapterListener rvAdapterListener;
    ...
    public HistoryRvAdapter(RvAdapterListener rvAdapterListener)
    {
        this.rvAdapterListener = rvAdapterListener;
    }

    @Override
    public HitoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
